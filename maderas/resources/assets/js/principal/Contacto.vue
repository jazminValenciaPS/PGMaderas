                    ...
                    <form action="contact" method="POST"  id="form">
                        ...
                        <div class="row">
                            ...
                            <div class="input-field col s6">
                                ...
                                <input id="last_name" name="nombre"  type="text" required="required" class="validate">
                                <label for="name">Nombre</label>
                            </div>
                            <div class="input-field col s6">
                                <i class="material-icons prefix">phone</i>
                                <input id="last_name" name=telefono type="tel" required="required"  class="validate">
                        ...
                        <div class="row">
                            <div class="input-field col s12">
                                ...
                                <textarea id="icon_prefix2" name="mensaje"  required="required" class="materialize-textarea"></textarea>
